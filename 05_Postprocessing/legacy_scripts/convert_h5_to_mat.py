...
output_file_example = "/net/micdata/data2/12IDC/ptychosaxs/batch_mode_250/RSM/best_model_LatticeSC_Probe256x256_ZCB_9_3D__noNoise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_250_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5"

base_dir = "/net/micdata/data2/12IDC/ptychosaxs/batch_mode_250/RSM/"
output_files=[
            #"best_model_LatticeClathII_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_L1_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeClathII_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_L2_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeClathII_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5",
            "best_model_LatticeClathII_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_250_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__noNoise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_L1_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__noNoise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_L2_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__noNoise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__noNoise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_250_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_L1_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_L2_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_50_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5",
            #"best_model_LatticeSC_Probe256x256_ZCB_9_3D__Noise_sim_ZCB_9_3D_S5065_N600_steps4_dp256_Unet_epoch_250_pearson_loss_symmetry_0.0/combined_diffraction_patterns.h5",
           ]

output_files = [base_dir + file for file in output_files]

for output_file in output_files:
    print(output_file)

    save_string = output_file.replace('combined_diffraction_patterns.h5', 'combined_diffraction_patterns_processed.mat')
    print(save_string)
    scan_num_start=5003
    size=366
    ...
    if save_mat:
        savemat(save_string, final)
        print("Saved mat file: ", save_string)
    else:
